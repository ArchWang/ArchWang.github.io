...
url = "http://list.mp3.baidu.com/list/shaoergequ.html"
...
TheBody=replace(TheBody,"http://mp3.baidu.com/m?tn=baidump3&ct=134217728&lm=-1&li=510&word=", path & listfilename & "?"&key1&"=")
TheBody=replace(TheBody,"http://mp3.baidu.com/m?f=ms&tn=baidump3&ct=134217728&lf=&rn=&word=", path & listfilename & "?"&key1&"=")
TheBody=replace(TheBody,"width=""100%""","width=""770""")
end if
