...
url = "http://list.mp3.baidu.com/list/xiangsheng.html"
...
TheBody=replace(TheBody,"http://mp3.baidu.com/m?tn=baidump3&ct=134217728&lm=-1&li=504&word=", path & listfilename & "?"&key1&"=")
TheBody=replace(TheBody,"<a href=""xiangshengmingjia.html"" ><strong>  相声名家  </strong></a>","")
TheBody=replace(TheBody,"<a href=""xiaopin.html""><b>小品荟萃</b></a>","")
end if
