...
url = "http://list.mp3.baidu.com/list/tvs.html"

ComStr = GetPage(url)
if err.number=0 then

TheBody = GetContent(Comstr,"<table width=""100%"" align=""center"" cellpadding=""0"" cellspacing=""0"">","<input type=hidden name=refreshtime value=@-RESBODY-@>",0)

TheBody=replace(TheBody,"http://mp3.baidu.com/m?tn=baidump3&ct=134217728&lm=-1&li=80&word=",listfilename & "?"&key1&"=")
TheBody=replace(TheBody,"http://list.mp3.baidu.com/list/movies.html","mp3movie.asp")
...
<!-- #include file="top.asp"-->
	...
	<DIV id="title">
		<DIV><table width="100%" align="center" cellpadding="0" cellspacing="0"><%=TheBody%></table></DIV>
	</DIV>
