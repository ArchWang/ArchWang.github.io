...
url = "http://list.mp3.baidu.com/singer/singers.html"
ComStr = GetPage(url)
if err.number=0 then
TheBody = GetContent(Comstr,"</iframe>","<td height=""1"" colspan=""2""></td>",0)
Set Re=new RegExp
Re.Global = True
Re.Pattern="<a href=""(\S+?)_simp3.htm"" target=_blank>(\S+?)</a>"
TheBody =Re.Replace(TheBody,"<a href="""& path & listfilename &"?"& key1 &"=$2"" target=_blank>$2</a>")
Set Re=Nothing
end if
%>
<HTML>
<HEAD>
<TITLE>部分歌手列表 - 二度网MP3搜索引擎</TITLE>
...
.f14tit {
	FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 20px; TEXT-DECORATION: none
}
A.f14tit:link {
	FONT-SIZE: 14px; CURSOR: hand; COLOR: #ffffff; TEXT-DECORATION: none
}
A.f14tit:visited {
	FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 20px;TEXT-DECORATION: none
}
A.f14tit:active {
	FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 20px;TEXT-DECORATION: none
}
A.f14tit:hover {
	FONT-SIZE: 14px; COLOR: #ffffff; LINE-HEIGHT: 20px;TEXT-DECORATION: underline
}

A.n12:link {
	FONT-SIZE: 12px; COLOR: #333333; LINE-HEIGHT: 18px;font-weight: bold;TEXT-DECORATION: none
}
A.n12:visited {
	FONT-SIZE: 12px; COLOR: #333333; LINE-HEIGHT: 18px;font-weight: bold;TEXT-DECORATION: none
}
...
A.n12:hover {
	FONT-SIZE: 12px; COLOR: #FFFFFF; LINE-HEIGHT: 18px;font-weight: bold;TEXT-DECORATION: none
}
.border {font-size: 14px;padding-right: 10px; width: 20%; background: #fff; height: 28px;}
...
.p14{font-size:14px;}
.s18 {padding-left: 10px; font-size: 14px;color: #000; font-weight: 300; FONT-FAMILY:  "Arial"}
body,td,th {
	font-family: 宋体;
}
